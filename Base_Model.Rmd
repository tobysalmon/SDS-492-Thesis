...
model {
  ...
  r[1] ~ dgamma(0.1, 0.1)   # Flu
  r[3] ~ dgamma(0.1, 0.1)   # COVID
  r[4] ~ dgamma(0.1, 0.1)   # ILI
}
"
...
for (h in 1:n_holdout) {
  ...
  eval_results$crps_ili[h] <- crps_sample(y = eval_results$actual_ili[h], dat = ili_samples)
}
